...
|-------|-------------|-----------|
| **Skills** | `/distill`, `/recall`, `/pour`, `/bookmark`, `/minutes`, `/classify` — CLAUDE.md files that orchestrate MCP tool calls | — |
| **MCP Server** | FastMCP server exposing 11 tools over stdio transport | `mcp/server.py` |

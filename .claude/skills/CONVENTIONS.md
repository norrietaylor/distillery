...
| `/watch` | `watch/` | distillery_watch, CronCreate/RemoteTrigger | Manage monitored feed sources + auto-poll scheduling |
| `/radar` | `radar/` | distillery_list, distillery_suggest_sources, distillery_store, distillery_rescore | Ambient feed digest and source suggestions |

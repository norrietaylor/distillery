...
| 14 | Namespace taxonomy | Hierarchical validated tag system (`/project/billing-v2/decisions`) | Not started |
| 15 | Provenance tracking | Full version history, source chain, author chain | Not started |
| 16 | Port type schemas | `person`, `project`, `digest`, `github` entry types | Not started |

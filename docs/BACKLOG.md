...
**Completed specs:** 01 (storage/data model), 02 (core skills), 03 (classification), 04 (public release), 05 (developer experience), 06 (MVP maturity), 07 (FastMCP migration), 08 (infrastructure improvements), 10 (GitHub team OAuth).

**Current state:** 17 MCP tools, FastMCP 2.12+, stdio + HTTP transport, GitHub OAuth, Python 3.11-3.13 CI matrix, 80% coverage threshold, 860+ tests.
